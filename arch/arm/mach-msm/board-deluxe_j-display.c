...
static int deluxe_j_display_on(struct platform_device *pdev)
{
	struct msm_fb_data_type *mfd;
...
static int deluxe_j_display_off(struct platform_device *pdev)
{
	struct msm_fb_data_type *mfd;
...
static struct msm_fb_panel_data deluxe_j_panel_data = {
	...
	.late_init = deluxe_j_display_on,
	.early_off = deluxe_j_display_off,
};
...
static int __init deluxe_j_panel_init(void)
{
	...
	if (panel_type == PANEL_ID_DLXJ_SHARP_RENESAS) {
		...
		PR_DISP_INFO("match PANEL_ID_DLXJ_SHARP_RENESAS panel_type\n");
	} else if (panel_type == PANEL_ID_DLXJ_SONY_RENESAS) {
		mipi_video_sony_init();
		PR_DISP_INFO("match PANEL_ID_DLXJ_SONY_RENESAS panel_type\n");
	} else {
